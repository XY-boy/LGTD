...
from modules.ablation_model.model_final import myNet as Net
...
parser.add_argument('--data_dir', type=str, default='E:\VSR_new_data')
parser.add_argument('--file_list', type=str, default='test_list3.txt')
...
parser.add_argument('--output', default='Results/Ours-final-epoch9-208/', help='Location to save checkpoint models')
parser.add_argument('--model', default='weights_model-final/4x_XYMSDTGPmodel-1_epoch_9.pth', help='sr pretrained base model')
...
def eval():
    ...
    for batch in testing_data_loader:
        ...
        folder_name = '{0:04d}'.format(folder+208)
